...
const Salas = () => {
  ...
  const handleRemove = (sede) => {
    dispatch(sedeRemove(sede.id));
  };
              ...
              <lu className=" form-sucursal">
                {data.map((sede) => (
                  <li className="list-model list-group-item" key={sede.id}>
                    ...
                    <div>
                      <i
                        class="fas fa-pen mr-2 cursor ml-5"
                        onClick={() => actualizarSede(sede, 'editar')}
                      ></i>
                      <i
                        class="fas fa-trash-alt cursor ml-2"
                        onClick={() => handleRemove(sede)}
                      ></i>
                    </div>
                  </li>
                ))}
