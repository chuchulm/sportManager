...
import Contrasena from '../pages/wizard/Contrasena';
import Sucursales from '../pages/wizard/Empleados';
import Salas      from '../pages/wizard/Salas';
import Actividades from '../pages/wizard/Actividades';
import Membresias from '../pages/wizard/Membresias';
import Empleados from '../pages/wizard/Empleados';
